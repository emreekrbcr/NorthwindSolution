...
namespace Core.DependencyResolvers
{
    public class CoreModule : ICoreModule
    {
        ...
        {
            serviceCollection.AddSingleton<IHttpContextAccessor, HttpContextAccessor>(); //Bu çözümlemeyi burada ekle aşağıda ise ServiceTool'u çağırmamız gerekiyor aksi takdirde Program.cs'nin içerisinde çözümleyici olarak Autofac'i kullandığımız ve sisteme entegre ettiğimiz için sistem buradaki çözümlemeleri yapamaz. Bunu normalde Startup.cs'in içine eklemiştik ama sonradan tüm projelerde kullanılabilecek bir çözümleme old. için Core'a aldık 
